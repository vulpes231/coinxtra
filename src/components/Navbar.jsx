    ...
    <header className="p-3 w-full h-[60px] flex items-center justify-center font-[Poppins]">
      <nav className="md:max-w-[900px] md:mx-auto flex items-center justify-between w-full">
        <span className="flex items-center">
          ...
          <h1 className="uppercase font-bold">coinxtra</h1>
        </span>
        ...
        <div className="hidden md:flex items-center gap-4">
          <button className={`${styles.button} bg-slate-900 text-white`}>
            sign up
          </button>
          <button
            className={`${styles.button} border-2 border-slate-950 hover:border-none hover:bg-slate-950 hover:text-white`}
          >
            sign in
          </button>
        </div>
